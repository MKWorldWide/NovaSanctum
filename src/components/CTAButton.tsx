...
const CTAButton = ({
  ...
  const baseClasses = 'relative inline-flex items-center justify-center font-medium transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-neon-cyan';
  
  const variantClasses = {
    primary: 'bg-gradient-to-r from-neon-cyan to-synth-purple text-bio-dark hover:from-neon-cyan/90 hover:to-synth-purple/90',
